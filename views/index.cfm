...
<cfoutput>
	...
	<cfif cb.categoryFilterExists()>
		<div class="buttonBar">
			<button class="button2" onclick="window.location = ('#cb.linkBlog()#')" title="Remove filter and view all entries">Remove Filter</button>
		</div>
		<div class="infoBar">
	...
	<cfif cb.searchTermExists()>
		<div class="buttonBar">
			<button class="button2" onclick="window.location = ('#cb.linkBlog()#')" title="Clear search and view all entries">Clear Search</button>
		</div>
		<div class="infoBar">
